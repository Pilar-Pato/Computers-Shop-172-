...
public class StoreTest {
    ...
    void testGetComputers() {
        Computer computer1 = new Computer("HP", 8, "Intel i7", "Windows 11", 1200.0);
        Computer computer2 = new Computer("MacBook", 32, "M2", "macOS", 2500.0);
        List<Computer> computers = Arrays.asList(computer1, computer2);
        Store store = new Store("PCPATO", "Pilar Pato", 0000111, computers);
    ...
    void testGetName() {
        ...
        Store store = new Store("PCPATO", "Pilar Pato", 0000111, computers);
        assertThat(store.getName(), is(equalTo("PCPATO")));

    }

    @Test
    void testGetOwner() {
        Store store = new Store("PCPATO", "Pilar Pato", 0000111, null);
        assertThat(store.getOwner(), is(equalTo("Pilar Pato")));
    }

    @Test
    void testGetTaxId() {
        Store store = new Store("PCPATO", "Pilar Pato", 0000111, null);
        assertThat(store.getTaxId(), is(0000111));
    }

    @Test
    void testSetComputers() {
        Computer computer1 = new Computer("HP", 8, "Intel i7", "Windows 10", 1500.0);
        Computer computer2 = new Computer("MacBook", 16, "M1", "macOS", 2500.0);
        List<Computer> computers = Arrays.asList(computer1, computer2);
        Store store = new Store("PCPATO", "Pilar Pato", 0000123, computers);
